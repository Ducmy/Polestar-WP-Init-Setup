...
<head>
	...
	<?php if (is_single()) :
		$uniqueLoad = array(
			array("type" => "css", "src" => get_stylesheet_directory_uri()   . "/includes/css/single.css"),
			array("type" => "js", "src" => get_stylesheet_directory_uri() . "/includes/js/single.js"),
		);
	endif;
...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		...
		<header id="masthead" class="site-header<?php if (get_theme_mod('header_layout') == 'centered') echo ' centered';
												if (get_theme_mod('sticky_header', true)) echo ' sticky';
												if (get_theme_mod('tagline') && get_bloginfo('description')) echo ' tagline';
												if (get_theme_mod('mobile_menu', true)) echo ' mobile-menu'; ?>" <?php if (get_theme_mod('sticky_header_scaling')) echo 'data-scale-logo="true"' ?>>
			<ul class="small-top-menu">
				<li class="small-top-menu-item">
					<a href="tel:0904217037">0904217037</a>
				</li>
				<li class="small-top-menu-item">
					<a href="javascript:void(0)">info@mkedic.com.vn</a>
				</li>
				<li class="small-top-menu-item">
